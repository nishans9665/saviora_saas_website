...
export function AboutUsClient() {
  ...
  return (
    <>
      <Navbar />
      <main className="flex flex-col min-h-screen pt-28 relative overflow-hidden bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
        
        {/* Background Decorative Gradients */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[900px] max-w-[1400px] opacity-25 pointer-events-none">
          <div className="absolute top-12 left-1/4 w-96 h-96 bg-emerald-500 rounded-full mix-blend-multiply filter blur-[120px]"></div>
          <div className="absolute top-32 right-1/4 w-96 h-96 bg-primary-400 rounded-full mix-blend-multiply filter blur-[120px]"></div>
        </div>
        ...
        <section className="relative pt-12 pb-20 md:pt-16 md:pb-28">
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <AnimatedSection className="text-center max-w-4xl mx-auto">
              <span className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-100/80 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-300 text-xs sm:text-sm font-semibold tracking-wide uppercase mb-6 border border-emerald-200/80 dark:border-emerald-800/60 shadow-xs">
              ...
              <p className="text-lg sm:text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto mb-8 leading-relaxed font-normal">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
                ...
                >
                  <Button size="lg" className="w-full sm:w-auto shadow-lg shadow-emerald-600/20 text-base font-semibold px-8 py-3.5 rounded-xl">
                    Start Free
                    <ArrowRight className="w-5 h-5 ml-1" />
                  </Button>
                </a>
                <Link href="/#features">
                  <Button variant="outline" size="lg" className="w-full sm:w-auto text-base font-semibold px-8 py-3.5 rounded-xl border-slate-300 dark:border-slate-800">
                    Explore Features
                  </Button>
                </Link>
              </div>
            ...
            <AnimatedSection delay={0.2} direction="up" className="max-w-5xl mx-auto">
              <div className="relative rounded-3xl p-3 bg-gradient-to-b from-slate-200/80 to-slate-100/40 dark:from-slate-800/80 dark:to-slate-900/40 border border-slate-200 dark:border-slate-800 shadow-2xl">
                <div className="rounded-2xl bg-white dark:bg-slate-900 overflow-hidden border border-slate-200/80 dark:border-slate-800 p-6 md:p-8">
                  {/* Header Bar */}
                  <div className="flex items-center justify-between pb-6 mb-6 border-b border-slate-100 dark:border-slate-800">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="ml-2 text-xs font-mono text-slate-400 dark:text-slate-500">app.saviora.com/overview</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="px-2.5 py-1 rounded-lg bg-emerald-50 dark:bg-emerald-950/60 text-emerald-600 dark:text-emerald-400 text-xs font-medium border border-emerald-200/40">
                        Live Demo
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800">
                      ...
                      <div className="text-2xl font-bold text-slate-900 dark:text-white">$24,850.00</div>
                    ...
                    <div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800">
                      ...
                      <div className="text-2xl font-bold text-slate-900 dark:text-white">$3,200.00</div>
                    ...
                    <div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800">
                      ...
                      <div className="text-2xl font-bold text-slate-900 dark:text-white">$12,000.00</div>
        ...
        <section className="py-16 md:py-24 bg-white dark:bg-slate-900 border-y border-slate-200/80 dark:border-slate-800">
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-4xl mx-auto">
              <AnimatedSection className="text-center mb-12">
                ...
                <div className="p-4 rounded-2xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200/80 dark:border-emerald-800/60 inline-block text-emerald-800 dark:text-emerald-300 font-semibold text-sm sm:text-base">
              ...
              <AnimatedSection delay={0.2} className="mt-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                  <div className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 text-center">
                    <div className="w-12 h-12 mx-auto mb-4 rounded-xl bg-red-100 dark:bg-red-950/60 text-red-600 dark:text-red-400 flex items-center justify-center font-bold">
                      ✕
                    </div>
                    <h3 className="font-bold text-slate-900 dark:text-white mb-2">Scattered Finances</h3>
                  ...
                  <div className="flex flex-col items-center justify-center p-4">
                    <div className="w-12 h-12 rounded-full bg-emerald-600 text-white flex items-center justify-center font-bold shadow-lg shadow-emerald-600/30 mb-2">
                      <Sparkles className="w-6 h-6" />
                    </div>
                    <span className="text-xs font-semibold text-emerald-600 dark:text-emerald-400 uppercase tracking-wider">Saviora Platform</span>
                  </div>

                  <div className="p-6 rounded-2xl bg-emerald-50/60 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800/60 text-center">
                    <div className="w-12 h-12 mx-auto mb-4 rounded-xl bg-emerald-100 dark:bg-emerald-900/60 text-emerald-600 dark:text-emerald-400 flex items-center justify-center font-bold">
                      ✓
                    </div>
                    <h3 className="font-bold text-slate-900 dark:text-white mb-2">Clearer Financial Picture</h3>
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4 md:px-6">
            <AnimatedSection className="text-center max-w-3xl mx-auto mb-16">
              <span className="text-xs font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-wider mb-3 block">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <AnimatedSection delay={0.1} direction="up">
                <div className="h-full p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xl hover:border-emerald-500/50 transition-all duration-300 flex flex-col justify-between">
                  <div>
                    <div className="w-14 h-14 rounded-2xl bg-emerald-100 dark:bg-emerald-950/70 text-emerald-600 dark:text-emerald-400 flex items-center justify-center mb-6 shadow-sm">
                    ...
                    <h4 className="text-sm font-semibold text-emerald-700 dark:text-emerald-400 mb-4">
              ...
              <AnimatedSection delay={0.2} direction="up">
                <div className="h-full p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xl hover:border-emerald-500/50 transition-all duration-300 flex flex-col justify-between">
                  <div>
                    <div className="w-14 h-14 rounded-2xl bg-blue-100 dark:bg-blue-950/70 text-blue-600 dark:text-blue-400 flex items-center justify-center mb-6 shadow-sm">
                      <PiggyBank className="w-7 h-7" />
                    </div>
                    <span className="text-xs font-bold text-blue-600 dark:text-blue-400 tracking-widest uppercase mb-2 block">
                      PHILOSOPHY 02
                    </span>
                    <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">SAVE</h3>
                    <h4 className="text-sm font-semibold text-blue-700 dark:text-blue-400 mb-4">
              ...
              <AnimatedSection delay={0.3} direction="up">
                <div className="h-full p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xl hover:border-emerald-500/50 transition-all duration-300 flex flex-col justify-between">
                  <div>
                    <div className="w-14 h-14 rounded-2xl bg-purple-100 dark:bg-purple-950/70 text-purple-600 dark:text-purple-400 flex items-center justify-center mb-6 shadow-sm">
                      <Compass className="w-7 h-7" />
                    </div>
                    <span className="text-xs font-bold text-purple-600 dark:text-purple-400 tracking-widest uppercase mb-2 block">
                      PHILOSOPHY 03
                    </span>
                    <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">GROW</h3>
        ...
        <section className="py-16 md:py-24 bg-slate-100/60 dark:bg-slate-900/60 border-y border-slate-200/80 dark:border-slate-800">
          <div className="container mx-auto px-4 md:px-6">
            <AnimatedSection className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <AnimatedSection delay={0.1}>
                <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-md hover:shadow-lg transition-all">
                  <div className="text-xs font-mono font-bold text-emerald-600 dark:text-emerald-400 mb-3">01</div>
                  <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
                    <Wallet className="w-5 h-5 text-emerald-600" /> Track Income
                  </h3>
                  <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
              ...
              <AnimatedSection delay={0.15}>
                <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-md hover:shadow-lg transition-all">
                  ...
                  <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
                    <PieChart className="w-5 h-5 text-blue-600" /> Manage Expenses
                  </h3>
                  <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
              ...
              <AnimatedSection delay={0.2}>
                <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-md hover:shadow-lg transition-all">
                  ...
                  <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
                    <Target className="w-5 h-5 text-indigo-600" /> Plan Your Budget
                  </h3>
                  <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
              ...
              <AnimatedSection delay={0.25}>
                <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-md hover:shadow-lg transition-all">
                  ...
                  <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
                    <PiggyBank className="w-5 h-5 text-purple-600" /> Build Savings Goals
                  </h3>
                  <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
              ...
              <AnimatedSection delay={0.3}>
                <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-md hover:shadow-lg transition-all">
                  ...
                  <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
                    <BarChart3 className="w-5 h-5 text-amber-600" /> Understand Your Finances
                  </h3>
                  <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
              ...
              <AnimatedSection delay={0.35}>
                <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-md hover:shadow-lg transition-all">
                  ...
                  <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
                    <Globe className="w-5 h-5 text-teal-600" /> Manage Your Financial Life
                  </h3>
                  <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <AnimatedSection delay={0.1}>
                  <div className="relative p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-lg text-center h-full flex flex-col items-center">
                    <div className="w-12 h-12 rounded-full bg-emerald-100 dark:bg-emerald-950 text-emerald-600 dark:text-emerald-400 font-bold flex items-center justify-center mb-4 text-base">
                      01
                    </div>
                    <h3 className="font-bold text-slate-900 dark:text-white text-lg mb-2">Track</h3>
                ...
                <AnimatedSection delay={0.2}>
                  <div className="relative p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-lg text-center h-full flex flex-col items-center">
                    <div className="w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-950 text-blue-600 dark:text-blue-400 font-bold flex items-center justify-center mb-4 text-base">
                      02
                    </div>
                    <h3 className="font-bold text-slate-900 dark:text-white text-lg mb-2">Plan</h3>
                    <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                ...
                <AnimatedSection delay={0.3}>
                  <div className="relative p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-lg text-center h-full flex flex-col items-center">
                    <div className="w-12 h-12 rounded-full bg-indigo-100 dark:bg-indigo-950 text-indigo-600 dark:text-indigo-400 font-bold flex items-center justify-center mb-4 text-base">
                      03
                    </div>
                    <h3 className="font-bold text-slate-900 dark:text-white text-lg mb-2">Understand</h3>
                    <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                ...
                <AnimatedSection delay={0.4}>
                  <div className="relative p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-lg text-center h-full flex flex-col items-center">
                    <div className="w-12 h-12 rounded-full bg-purple-100 dark:bg-purple-950 text-purple-600 dark:text-purple-400 font-bold flex items-center justify-center mb-4 text-base">
                      04
                    </div>
                    <h3 className="font-bold text-slate-900 dark:text-white text-lg mb-2">Grow</h3>
                    <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              <AnimatedSection delay={0.1}>
                <div className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200/80 dark:border-slate-800">
                  <h3 className="font-bold text-slate-900 dark:text-white text-base mb-2">Everyday Spending</h3>
              ...
              <AnimatedSection delay={0.2}>
                <div className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200/80 dark:border-slate-800">
                  <h3 className="font-bold text-slate-900 dark:text-white text-base mb-2">Monthly Planning</h3>
                  <p className="text-slate-600 dark:text-slate-400 text-xs leading-relaxed">
              ...
              <AnimatedSection delay={0.3}>
                <div className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200/80 dark:border-slate-800">
                  <h3 className="font-bold text-slate-900 dark:text-white text-base mb-2">Saving for the Future</h3>
                  <p className="text-slate-600 dark:text-slate-400 text-xs leading-relaxed">
              ...
              <AnimatedSection delay={0.4}>
                <div className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200/80 dark:border-slate-800">
                  <h3 className="font-bold text-slate-900 dark:text-white text-base mb-2">Financial Awareness</h3>
                  <p className="text-slate-600 dark:text-slate-400 text-xs leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <AnimatedSection delay={0.1}>
                <div className="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xl">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Financial Health</h3>
                  <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
              ...
              <AnimatedSection delay={0.2}>
                <div className="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xl">
                  <div className="w-12 h-12 rounded-xl bg-blue-100 dark:bg-blue-950 text-blue-600 dark:text-blue-400 flex items-center justify-center mb-6">
                    <BarChart3 className="w-6 h-6" />
                  </div>
                  <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Spending Insights</h3>
                  <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
              ...
              <AnimatedSection delay={0.3}>
                <div className="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xl">
                  <div className="w-12 h-12 rounded-xl bg-purple-100 dark:bg-purple-950 text-purple-600 dark:text-purple-400 flex items-center justify-center mb-6">
                    <Layers className="w-6 h-6" />
                  </div>
                  <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Financial Reports</h3>
                  <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-12">
              <AnimatedSection delay={0.1}>
                <div className="p-6 rounded-2xl bg-slate-800/80 border border-slate-700/80">
                  ...
                  <h3 className="font-bold text-lg mb-2">Secure Account Access</h3>
              ...
              <AnimatedSection delay={0.2}>
                <div className="p-6 rounded-2xl bg-slate-800/80 border border-slate-700/80">
                  ...
                  <h3 className="font-bold text-lg mb-2">Protected Financial Data</h3>
                  <p className="text-slate-300 text-xs leading-relaxed">
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-12">
              <AnimatedSection delay={0.1}>
                <div className="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl flex flex-col justify-between h-full">
                  <div>
                    <div className="w-12 h-12 rounded-xl bg-emerald-100 dark:bg-emerald-950 text-emerald-600 dark:text-emerald-400 flex items-center justify-center mb-6">
                      <Laptop className="w-6 h-6" />
                    </div>
                    <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Saviora Web</h3>
                  ...
                  <a href="https://cloud.saviora.app/register" target="_blank" rel="noopener noreferrer">
              ...
              <AnimatedSection delay={0.2}>
                <div className="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl flex flex-col justify-between h-full">
                  <div>
                    ...
                    <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Saviora Mobile</h3>
                    <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed mb-6">
        ...
        <section className="py-20 md:py-28 bg-slate-900 text-white relative overflow-hidden">
          ...
          <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-emerald-500/15 rounded-full blur-[140px] pointer-events-none"></div>
          <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-blue-500/15 rounded-full blur-[140px] pointer-events-none"></div>
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto mb-16">
              ...
              <AnimatedSection delay={0.1} direction="right">
                <div className="h-full p-8 sm:p-10 rounded-3xl overflow-hidden bg-slate-800/80 backdrop-blur-xl border border-slate-700/80 shadow-2xl flex flex-col justify-between relative group hover:border-emerald-500/50 transition-all duration-300">
                  <div className="absolute top-0 right-0 w-36 h-36 bg-emerald-500/10 rounded-bl-full pointer-events-none transition-all duration-500 group-hover:scale-110"></div>
              ...
              <AnimatedSection delay={0.2} direction="left">
                <div className="h-full p-8 sm:p-10 rounded-3xl overflow-hidden bg-slate-800/80 backdrop-blur-xl border border-slate-700/80 shadow-2xl flex flex-col justify-between relative group hover:border-blue-500/50 transition-all duration-300">
                  <div className="absolute top-0 right-0 w-36 h-36 bg-blue-500/10 rounded-bl-full pointer-events-none transition-all duration-500 group-hover:scale-110"></div>
                  <div className="relative z-10">
                    <div className="flex items-center justify-between mb-6">
                      <div className="w-14 h-14 rounded-2xl bg-blue-500/20 text-blue-400 flex items-center justify-center border border-blue-500/30 shadow-inner">
            ...
            <AnimatedSection delay={0.3} className="max-w-3xl mx-auto text-center">
              <div className="p-6 sm:p-8 rounded-2xl bg-gradient-to-r from-emerald-900/60 via-slate-800 to-blue-900/60 backdrop-blur-xl border border-emerald-500/30 text-white shadow-xl relative">
                <p className="text-lg sm:text-xl font-bold tracking-wide text-emerald-300 mb-2">
        ...
        <section className="py-16 md:py-24 bg-white dark:bg-slate-900 border-b border-slate-200/80 dark:border-slate-800">
          <div className="container mx-auto px-4 md:px-6">
            <AnimatedSection className="max-w-4xl mx-auto">
              <div className="p-8 sm:p-12 rounded-3xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-800 shadow-lg">
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
                  ...
                  <div className="flex-shrink-0">
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      <Button size="lg" className="whitespace-nowrap shadow-md">
                        Visit Codefox IT
                ...
                <AnimatedSection key={index} delay={index * 0.05}>
                  <div className="border border-slate-200 dark:border-slate-800 rounded-2xl bg-white dark:bg-slate-900 overflow-hidden shadow-xs">
                    <button
                      ...
                      className="w-full text-left p-5 sm:p-6 font-bold text-slate-900 dark:text-white flex items-center justify-between gap-4 hover:text-emerald-600 transition-colors"
                    >
                    ...
                    <AnimatePresence>
                      {openFaq === index && (
                        ...
                        >
                          <div className="px-5 pb-6 sm:px-6 sm:pb-6 text-sm text-slate-600 dark:text-slate-300 leading-relaxed border-t border-slate-100 dark:border-slate-800/80 pt-4">
                            {item.answer}
                          </div>
                        </motion.div>
                      )}
        ...
        <section className="py-16 md:py-24 bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900 border-t border-slate-200/80 dark:border-slate-800">
          <div className="container mx-auto px-4 md:px-6">
            <AnimatedSection className="max-w-4xl mx-auto text-center">
              <div className="p-8 sm:p-14 rounded-3xl bg-slate-900 text-white shadow-2xl relative overflow-hidden">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6">
                  <a href="https://cloud.saviora.app/register" target="_blank" rel="noopener noreferrer">
                    <Button size="lg" className="w-full sm:w-auto text-base font-semibold px-8 py-3.5 rounded-xl shadow-lg shadow-emerald-600/30">
                      Start Free
                      <ArrowRight className="w-5 h-5 ml-1" />
                    </Button>
                  </a>
                  <Link href="/#features">
                    <Button variant="outline" size="lg" className="w-full sm:w-auto text-base font-semibold px-8 py-3.5 rounded-xl border-slate-700 text-slate-200 hover:bg-slate-800">
                      Explore Saviora
                    </Button>
                  </Link>
                </div>
