...
export function Navbar() {
  ...
  return (
    ...
    >
      <AnnouncementBar />
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between py-2.5 sm:py-3">
        {/* Logo */}
        <Link href="/" className="flex items-center gap-2">
          <Image src={logoSaviora} alt="Saviora" width={200} height={71} unoptimized priority className="h-10 sm:h-11 md:h-12 w-auto object-contain" />
        </Link>
